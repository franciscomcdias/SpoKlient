...
import spoklient.logger
from spoklient.runtime.auth.base_token_provider import BaseTokenProvider


class ACSTokenProvider(BaseTokenProvider, spoklient.logger.LoggerContext):
    """ Provider to acquire the access token from a Microsoft Azure Access Control Service (ACS)"""

    def __init__(self, url, client_id, client_secret, proxy={}):
        self.url = url
